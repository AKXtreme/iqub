...
/// App-wide color palette — light mode constants.
/// For dark mode use [AppDarkColors].
class AppColors {
  AppColors._();

  static const primary = Color(0xFF1A56DB);
  static const primaryLight = Color(0xFF76A9FA);
...
class AppDarkColors {
  ...
  static const cardShadow = Color(0x3F000000);
}
